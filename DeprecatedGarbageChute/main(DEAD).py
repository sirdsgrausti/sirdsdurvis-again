...
# deprecated but kept so i can understand what can be kept from this... well all i fixed was the locatioon bug really..
# cannot settle on a goood name for this piece of work
# but who cares about placeholders? the mechanics must be perfected :-(
#######################
