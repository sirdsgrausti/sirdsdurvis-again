...
# player class with diff properties. MUST GET OPTIMISED AND WORK FROM ONE "ANCESTOR/PARENT" CLASS MAYBE???
class Partner(pygame.sprite.Sprite): # player class inherits sprite properties
    def __init__(self):
...
# move
    ...
    def vertical_movement(self, dt):
        ...
        if self.velocity.y > 5: self.velocity.y = 5  # vertical movement
    ...
    def jump(self):
        if self.on_ground: 
            ...
            self.velocity.y -= 12    # defines the jumping state & velocity ""pulling him down"""
...
## make her move and actually ppear on the screen
    ...
    def load_frames(self):      #learnd to use a spritesheet an d a json thing for it
        ...
        self.walking_frames_right = [chrspritesheet.parse_sprite("stwalk1.png"),
